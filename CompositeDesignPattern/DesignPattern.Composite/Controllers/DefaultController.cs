...
namespace DesignPattern.Composite.Controllers
{
    public class DefaultController:Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var values = Recursize(categories, new Category { CategoryName = "First Category", CategoryID = 0 },
                new ProductComposite ( 0, "First Composite" ));
        ...
        public ProductComposite Recursize(List<Category> categories,Category firstCategory,
            ProductComposite firstComposite,ProductComposite leaf=null)
        {
            categories.Where(x => x.UpperCategoryID == firstCategory.CategoryID).ToList().ForEach(y =>
            {
                ...
                Recursize(categories, y, firstComposite, productComposite);
            });
